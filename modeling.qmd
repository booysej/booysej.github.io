...
Hydro modelling and exploratory analysis of the Zambezi basin system, using both a [WEAP](https://www.weap21.org/) (Water evaluation and planning) optimization model and R. Converted an existing monthly WEAP model to an hourly model using [ERA5](https://www.ecmwf.int/en/forecasts/datasets/reanalysis-datasets/era5) rainfall data for the Kufue gorge hydro system. Random forest model for lake Kariba using both [historic satelite dam level values](https://dahiti.dgfi.tum.de/en/31/time_series/) and daily dam discharge values. Initial research was valuable.
