...
```{=tex}
\begin{huge}\begin{center}{\bf JACQUES BOOYSEN}\end{center}\end{huge}
```
<!-- CONTACT INFO -->

```{=tex}
\begin{center}booysenjacques@gmail.com ∙ \href{https://booysej.github.io/}{Portfolio} ∙ \href{https://github.com/booysej}{Github} ∙ \href{https://www.linkedin.com/in/jacques-booysen-3a1b921/}{LinkedIn}
\end{center}
\vspace{15pt}
```
...
\begin{large}
  ...
  \hrule
  \begin{multicols}{2}
    \begin{flushleft}{\bf University of Johannesburg}\end{flushleft}
    \begin{flushright}Jan 2002\end{flushright}
  \end{multicols}
  \vspace{-0.17cm}
  \begin{multicols}{2}
    \begin{flushleft}B.Sc (Hons) - Computer Science\end{flushleft}
    \begin{flushright}Johannesburg, South Africa\end{flushright}
  \end{multicols}
  \vspace{0.15cm}
\end{large}
```
...
\begin{large}
  ...
  \hrule
  \begin{multicols}{2}
    \begin{flushleft}{\bf Amazon Web Services}\end{flushleft}
    \begin{flushright}Aug 2022\end{flushright}
  \end{multicols}
  \vspace{-0.17cm}
  \begin{multicols}{2}
    \begin{flushleft}AWS Certified Solutions Architect – Associate\end{flushleft}
    \begin{flushright} \href{https://www.credly.com/badges/0ededfba-d894-4049-af5a-d0028f516a23/linked_in?t=rhbncw}{Verify Link} \end{flushright}
  \end{multicols}
  \vspace{0.15cm}
\end{large}
```
